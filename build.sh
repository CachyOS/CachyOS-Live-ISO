...
iso_name=cachyos
iso_label="CACHYOS"
iso_publisher="CachyOS GNU/Linux <https://cachyos.org>"
iso_application="CachyOS GNU/Linux Live/Rescue CD"
...
make_custom_airootfs() {
    ...
    echo "VERSION=$iso_version" >> "${_airootfs}/usr/lib/cachtyos-release"
