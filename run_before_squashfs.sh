...
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/cleaner_script.sh
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/chrooted_cleaner_script.sh
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/calamares_switcher
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/pacstrap_calamares
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/update-mirrorlist
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/calamares_for_testers
wget https://gitlab.com/cachyos/install-scripts/-/raw/master/prepare-calamares
